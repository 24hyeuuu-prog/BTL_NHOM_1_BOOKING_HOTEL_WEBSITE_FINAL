...
<head>
    ...
    <title>Phòng đã hoàn thành - LaValle</title>
...
<body>
    ...
    <div class="bookings-container">
        <div class="bookings-header">
            <h1>Phòng đã hoàn thành</h1>
            <p>Lịch sử các đặt phòng đã hoàn thành</p>
        </div>
                    ...
                    <div class="booking-card">
                        ...
                        <div class="booking-card-body">
                            ...
                            <div class="booking-actions">
                                ...
                                <a href="danhgia.php?id=<?php echo $booking['hotel_id']; ?>" class="btn btn-review">
                                    Đánh giá
                                </a>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div class="empty-message">
                ...
                <h2>Chưa có phòng nào hoàn thành</h2>
                <p>Khi bạn hoàn thành một kỳ lưu trú, nó sẽ xuất hiện ở đây.</p>
